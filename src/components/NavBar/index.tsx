         ...
         <header>
            <div className="nav-wrapper">
               <div className="logo-container">
                  <img className="logo" src="images/icon.svg" alt="Logo" /><Logo>&nbsp;JASV Finance</Logo>
               </div>
               <nav>
                  ...
                  <div className="nav-container">
                     <ul className="nav-tabs">
                        ...
                        <li className="nav-tab">
                           <Link to="/referrals" className="nav-links" onClick={() => { setIsChecked(!isChecked) }}>
                              REFERRALS
                           </Link>
                        </li>
                        {/* <li className="nav-tab">
                        ...
                        <li className="web3li insideMainNav">
                           <Link to="/" className="nav-links connect">
                              {account != null && account.length > 1 ?
                                 ...
                                 <UnlockButton style={{
                                    backgroundColor: '#778dfc !important',
                                    border: '0px',
